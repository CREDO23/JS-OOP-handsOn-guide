...
/**
 * 
 * The fact of being "public" defines visibility; for accessibility, we have properties that are
 * only accessible on instances of the class and other properties that are only accessible on 
 * the class itself.
 * 
 */
